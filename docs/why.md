...
`go-ruby-csv/csv` reimplements Ruby's CSV in **pure Go, with cgo disabled**. The
...
- any Go program can import `github.com/go-ruby-csv/csv` directly, with no Ruby runtime;
